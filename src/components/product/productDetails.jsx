...
export default class ProductGrid extends Component {
  componentWillMount = () => {
    this.props.timsanpham(this.props.match.params.id);
    console.log("initial call success", this.props.match.params.id)
  };
                  ...
                  <div className="product-details mb-30 pl-30">
                    ...
                    <div className="details-price mb-20">
                      ...
                      <span className="old-price">
                        {/* VND {props.selectedItem.price.toLocaleString()} */}
                      </span>
                    </div>
                      ...
                      <div className="product-info-list variant-item">
                        <ul>
                          ...
                          <li>
                            ...
                            {/* {props.selectedItem.product_id} */}
                          </li>
                          <li>
                            <span>Reward Points:</span> 100
                          </li>
                          <li>
                            <span>Stock:</span> <span className="in-stock">In Stock</span>
                          </li>
                        </ul>
                      </div>
